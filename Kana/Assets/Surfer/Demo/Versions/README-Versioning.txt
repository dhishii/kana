...
Hit play, and :
-clicking on the first button you will see the popup showing the layout for version 1
-clicking on the second button you will see the same reycled popup showing the layout for version 2