...
namespace Surfer
{
    public class SUToolsMenu : EditorWindow
    {
        ...
        static string _demoTKPackPath = "Assets/Surfer/TKDemo.unitypackage";
        ...
        [MenuItem("Tools/Surfer/Demo/Unpack Canvas")]
        static void Demo()
        {
        ...
        [MenuItem("Tools/Surfer/Demo/Unpack UIToolkit")]
        static void DemoTK()
        {

            if (System.IO.File.Exists(_demoTKPackPath))
            {
                AssetDatabase.ImportPackage(_demoTKPackPath, false);
                AssetDatabase.DeleteAsset(_demoTKPackPath);
