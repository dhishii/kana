    ...
    public static class SUSettingsRegister
    {
        ...
        public static SettingsProvider CreateSettingsProvider()
        {
            ...
            bool _justRenamed = default, _justAdded = default, _justRenamedEvent = default, _justAddedEvent = default,
                ...
                _charTweener = default, _bolt = default, _visualScripting = default;
            ...
            void AddUIToolkitSection()
            {
                GUIStyle style = new GUIStyle();
                style.fontStyle = FontStyle.Bold;
                style.normal.textColor = Color.white;
                EditorGUILayout.LabelField("UIToolkit", style);

                SurferHelper.SO.DoubleClickDelay = EditorGUILayout.FloatField("Double Click delay",SurferHelper.SO.DoubleClickDelay);
            }
            ...
            void GetSymbols()
            {
                ...
                _visualScripting = symbols.Contains(SurferHelper.VisualSSymbol);
            ...
            void AddIntegrationsSection()
            {
                ...
                _visualScripting = EditorGUILayout.Toggle("Visual Scripting", _visualScripting);
#else
                ...
                if (GUILayout.Button("Save And Recompile"))
                {
                    ...
                    UpdateSymbol(_oldInput,SurferHelper.OldInputSymbol);
                    UpdateSymbol(_newInput,SurferHelper.NewInputSymbol);
                    UpdateSymbol(_rewiredInput,SurferHelper.RewiredInputSymbol);
                    UpdateSymbol(_charTweener,SurferHelper.CharTweenerSymbol);
                    UpdateSymbol(_bolt,SurferHelper.BoltSymbol);
                    UpdateSymbol(_visualScripting,SurferHelper.VisualSSymbol);
            ...
            void UpdateSymbol(bool symbolBool,string symbolKey)
            {
                if (symbolBool && !symbols.Contains(symbolKey))
                    symbols += ";" + symbolKey;
                else if (!symbolBool && symbols.Contains(symbolKey))
                {
                    symbols = symbols.Replace(";" + symbolKey, "");
                    symbols = symbols.Replace(symbolKey, "");
                }
            }
