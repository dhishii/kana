...
namespace Surfer
{
    ...
    public class SUAnimationDataDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            _fullName = string.IsNullOrEmpty(label.text) ? property.displayName : label.text;
            _fullName += IsNone() ? "" : " (In Use) ";
            property.isExpanded = EditorGUI.Foldout(position,property.isExpanded, _fullName,true);
