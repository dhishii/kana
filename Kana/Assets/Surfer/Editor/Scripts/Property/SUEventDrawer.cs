...
namespace Surfer
{
    ...
    public class SUEventDrawer : PropertyDrawer
    {
        ...
        string[] GetEventList(SerializedProperty property)
        {
            ...
            bool isTk = property.IsFromToolkitCp();
            string[] list = !isTk ? property.GetCanvasEvents() : property.GetUIToolkitEvents();
            ...
            for (int i = 0; i < list.Length; i++)
            {
                ...
                if (!IsEventAvailable((SUEvent.Type_ID)i,property) && !isTk)
                {
                    list[i] = null;
                    continue;
                }
        ...
        bool IsEventAvailable(SUEvent.Type_ID eventID,SerializedProperty property)
        {
            ...
            if ((eventID == SUEvent.Type_ID.InputField_OnEndEdit
                ...
                || eventID == SUEvent.Type_ID.InputField_OnSubmit)
            ...
            if ((eventID == SUEvent.Type_ID.Slider_OnGreaterThan
                ...
                || eventID == SUEvent.Type_ID.Slider_OnValueChanged)
