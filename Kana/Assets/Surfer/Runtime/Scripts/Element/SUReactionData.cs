...
namespace Surfer
{
    ...
    public partial class SUReactionData
    {
        ...
        [SerializeField]
        SUTKPositionData _tkPosition = default;
        public SUTKPositionData TkPosition { get => _tkPosition; }

        [SerializeField]
        SUTKScaleData _tkScale = default;
        public SUTKScaleData TkScale { get => _tkScale; }

        [SerializeField]
        SUTKRotationData _tkRotation = default;
        public SUTKRotationData TkRotation { get => _tkRotation; }

        [SerializeField]
        SUTKColorData _tkColor = default;
        public SUTKColorData TkColor { get => _tkColor; }

        [SerializeField]
        SUTKSizeData _tkSize = default;
        public SUTKSizeData TkSize { get => _tkSize; }
        ...
        public void Play(SUElementData data,object evtData)
        {
            ...
            CustomReactionsExtensions.PlayReaction(_key, data, this, evtData);
        }
