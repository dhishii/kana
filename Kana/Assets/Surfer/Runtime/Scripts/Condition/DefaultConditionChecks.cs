...
namespace Surfer
{
    ...
    public static class DefaultConditionChecks
    {
        ...
        static void GetUnifiedNames()
        {
            ...
            UnifiedCanvasNames = GetAllCanvasNames().Union(ConditionChecksExtensions.GetAllCanvasNames()).ToArray();
            UnifiedUIToolkitNames = GetAllUIToolkitNames().Union(ConditionChecksExtensions.GetAllUIToolkitNames()).ToArray();
        }
#endif
        ...
        public readonly static Dictionary<string, PathFunc> All = new Dictionary<string, PathFunc>()
        {
            ...
            (input)=>
            {
                ...
                return input.gameObj.IsMyStateOpen(input.fieldsValues.Int_1);
            ...
            {"_SUtkve1",
            new PathFunc("VisualElement/IsEnabled",
            new List<PathField>()
            {
            ...
            (input)=>
            {
                ...
                {
                    output = element.enabledInHierarchy == input.fieldsValues.Bool_1;
                });
            ...
            {"_SUtkve2",
            new PathFunc("VisualElement/IsDisplayStyle",
            new List<PathField>()
            {
                new PathField("Who","_query"),
            ...
            (input)=>
            {
                ...
                input.GetQueryElements((element)=>
                {
                    output = element.resolvedStyle.display == (DisplayStyle)input.fieldsValues.Enum_1;
                });
